...
class CreateClusterIotNodelabelsTable extends Migration {
     ...
     */
    public function up() {
        Schema::create( 'cluster_iot_nodelabels', function ( Blueprint $table ) {
    ...
    public function down() {
        Schema::dropIfExists( 'cluster_iot_nodelabels' );
    }
}
