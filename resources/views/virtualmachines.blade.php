            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col m4 s12">
                            <input type="text" name="mac_ipmi" required="required" title="&nbsp;">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col m4 s12">
                            <input type="text" name="mac_eth2" required="required" title="&nbsp;">
                    ...
                    <div class="row">
                        <div class="input-field col m4 s12">
                            <input type="text" name="os" required="required" title="&nbsp;">
                            <label>OS *</label>
                        </div>
                        <div class="input-field col m4 s12">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col m4 s12">
                            <input type="text" name="tun_hostname">
