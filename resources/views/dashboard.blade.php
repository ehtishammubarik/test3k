...
<div id="main">
    <div class="row">
        <div class="col s12">
                            ...
                            <div class="col s12 m12 l4">
                                <div id="profile-card" class="card animate fadeRight">
                                    <div class="card-image waves-effect waves-block waves-light">
                                        <img class="activator" src="{{asset('public')}}/app-assets/images/gallery/3.png" alt="user bg" />
                                    </div>
                                    <div class="card-content">
                                        ...
                                        <ul class="widget-timeline mb-0">
                                            ...
                                            <li class="timeline-items timeline-icon-red active">
                                                ...
                                                <div class="timeline-content">
                                                    <img src="{{asset('public')}}/app-assets/images/icon/pdf.png" alt="document" height="30" width="25"
          ...
          <span class="avatar-status avatar-online avatar-50"><img src="{{asset('public')}}/app-assets/images/avatar/avatar-7.png"
                                                                   alt="avatar" />
          </span>
