...
<head>
    ...
    <!-- END : BEGIN: CDN JS -->
    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('public')}}/app-assets/css/custom/custom.css?{{md5_file(public_path('app-assets/css/custom/custom.css'))}}">
    <!-- END: Custom CSS-->
    <?php insert_tpl_file(); ?>
</head>
<!-- END: Head-->
